...
extern int maxRound;
extern int ballScore;
extern int pinScore;
extern int matchFinished;
...
#define BALL_SNAKE   6
#define BALL_ZIGZAG  8

// 特殊ボールの1ラウンド当たりの使用可能回数
#define SPECIAL_AMMO 3

extern int snakeAmmo; //スネーク残弾数
extern int zigzagAmmo;  //ジグザグ残弾数
